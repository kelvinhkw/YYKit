            ...
            if (_cache) {
                if (image || (_options & YYWebImageOptionRefreshImageCache)) {
                    ...
                    dispatch_async([YYWebImageOperation _imageQueue], ^{
                        YYImageCacheType cacheType = (self.options & YYWebImageOptionIgnoreDiskCache) ? YYImageCacheTypeMemory : YYImageCacheTypeAll;
                        [self.cache setImage:image imageData:data forKey:self.cacheKey withType:cacheType];
